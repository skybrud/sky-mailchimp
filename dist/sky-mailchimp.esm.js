...
var __vue_staticRenderFns__ = [];
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-0d300d1d_0", { source: "\n.sky-mailchimp{position:relative\n}\n.form-group{display:flex;flex-direction:column;align-items:flex-start;margin-bottom:0;color:#202227;order:1\n}\n.text-danger{display:none\n}\n&.submit{border-top:1px solid #ccc;padding-top:35px\n}\ninput[type=email]{margin-top:10px;width:100%;order:2;height:50px;font-size:inherit\n}\n.checkbox{position:relative;top:0;left:0;-moz-appearance:none;-webkit-appearance:none;border:none;background:0 0;z-index:1;padding:0;cursor:pointer\n}\nlabel{display:flex;align-items:center;margin-bottom:0;user-select:none;cursor:pointer\n}\n&:after{content:'';position:absolute;top:0;left:0;right:0;bottom:0;background-color:transparentize(#fff,.25)\n}\n.sky-mailchimp-loader-content{position:relative;z-index:1;display:flex;flex-direction:column;align-items:center;flex-grow:0;width:100%;padding-top:50px;padding-left:30px;padding-right:30px;text-align:center\n}\n@keyframes spinner{\nfrom{transform:rotate(0)\n}\nto{transform:rotate(360deg)\n}\n}", map: undefined, media: undefined });
